...
//     if (!leftWing.attached() || !rightWing.attached()) {
...
//             packet.rightHorizontal = map(packet.rightHorizontal, 0, 3900, 1000, 2000);
//             packet.rightVertical = map(packet.rightVertical, 0, 3900, 1000, 2000);

//             packet.leftHorizontal = map(packet.leftHorizontal, 0, 4095, 100, 0);
//             packet.leftVertical = map(packet.leftVertical, 0, 3900, 2000, 1000);

//             leftWing.write(packet.rightHorizontal);
//             rightWing.write(packet.rightHorizontal);
