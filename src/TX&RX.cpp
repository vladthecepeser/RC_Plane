...
//   SPI Pins used MOSI = 23, CE = 5, MSIO = 19, SCK = 18, CSN = 17
...
// // Uncomment the role you want to build for this board.
// // Define RADIO_ROLE_TX for the transmitter board and RADIO_ROLE_RX for the receiver board.
...
//   #if defined(RADIO_ROLE_TX)
//     role = true;
//     Serial.println(F("This is the TX node"));
//   #elif defined(RADIO_ROLE_RX)
//     role = false;
//     Serial.println(F("This is the RX node"));
//   #endif
...
//     if (report) {
//       Serial.print(F("[TX] Transmission successful! "));  // payload was delivered
...
//     } else {
//       Serial.println(F("[RX] Waiting for data..."));
//       delay(100);
//     }
//   }  // role
